...
public enum CurrencyEnum: RawRepresentable, Equatable, Hashable, CaseIterable, Apollo.JSONDecodable, Apollo.JSONEncodable {
  ...
  public static func == (lhs: CurrencyEnum, rhs: CurrencyEnum) -> Bool {
    switch (lhs, rhs) {
  ...
  public static var allCases: [CurrencyEnum] {
    return [
      .afn,
      .all,
      .azn,
...
public final class GetProductsQuery: GraphQLQuery {
  ...
  public let operationDefinition: String =
    """
    query GetProducts {
      categoryList(filters: {ids: {eq: "2324"}}) {
        __typename
        products {
          __typename
          total_count
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("categoryList", arguments: ["filters": ["ids": ["eq": "2324"]]], type: .list(.object(CategoryList.selections))),
      ]
    }
    ...
    public struct CategoryList: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("products", type: .object(Product.selections)),
        ]
      }
      ...
      public init(products: Product? = nil) {
        self.init(unsafeResultMap: ["__typename": "CategoryTree", "products": products.flatMap { (value: Product) -> ResultMap in value.resultMap }])
      }
      ...
      public struct Product: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["CategoryProducts"]

        public static var selections: [GraphQLSelection] {
          return [
            GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
            GraphQLField("total_count", type: .scalar(Int.self)),
        ...
        public init(totalCount: Int? = nil, items: [Item?]? = nil) {
          self.init(unsafeResultMap: ["__typename": "CategoryProducts", "total_count": totalCount, "items": items.flatMap { (value: [Item?]) -> [ResultMap?] in value.map { (value: Item?) -> ResultMap? in value.flatMap { (value: Item) -> ResultMap in value.resultMap } } }])
        }
        ...
        public var totalCount: Int? {
          get {
            return resultMap["total_count"] as? Int
          }
          set {
            resultMap.updateValue(newValue, forKey: "total_count")
          }
        }
        ...
        public struct Item: GraphQLSelectionSet {
          public static let possibleTypes: [String] = ["VirtualProduct", "SimpleProduct", "DownloadableProduct", "BundleProduct", "GroupedProduct", "ConfigurableProduct"]
          ...
          public static var selections: [GraphQLSelection] {
            return [
              ...
              GraphQLField("price_range", type: .nonNull(.object(PriceRange.selections))),
            ]
          }
          ...
          public static func makeVirtualProduct(uid: GraphQLID, sku: String? = nil, name: String? = nil, image: Image? = nil, priceRange: PriceRange) -> Item {
            return Item(unsafeResultMap: ["__typename": "VirtualProduct", "uid": uid, "sku": sku, "name": name, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "price_range": priceRange.resultMap])
          }

          public static func makeSimpleProduct(uid: GraphQLID, sku: String? = nil, name: String? = nil, image: Image? = nil, priceRange: PriceRange) -> Item {
            return Item(unsafeResultMap: ["__typename": "SimpleProduct", "uid": uid, "sku": sku, "name": name, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "price_range": priceRange.resultMap])
          }

          public static func makeDownloadableProduct(uid: GraphQLID, sku: String? = nil, name: String? = nil, image: Image? = nil, priceRange: PriceRange) -> Item {
            return Item(unsafeResultMap: ["__typename": "DownloadableProduct", "uid": uid, "sku": sku, "name": name, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "price_range": priceRange.resultMap])
          }

          public static func makeBundleProduct(uid: GraphQLID, sku: String? = nil, name: String? = nil, image: Image? = nil, priceRange: PriceRange) -> Item {
            return Item(unsafeResultMap: ["__typename": "BundleProduct", "uid": uid, "sku": sku, "name": name, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "price_range": priceRange.resultMap])
          }

          public static func makeGroupedProduct(uid: GraphQLID, sku: String? = nil, name: String? = nil, image: Image? = nil, priceRange: PriceRange) -> Item {
            return Item(unsafeResultMap: ["__typename": "GroupedProduct", "uid": uid, "sku": sku, "name": name, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "price_range": priceRange.resultMap])
          }

          public static func makeConfigurableProduct(uid: GraphQLID, sku: String? = nil, name: String? = nil, image: Image? = nil, priceRange: PriceRange) -> Item {
            return Item(unsafeResultMap: ["__typename": "ConfigurableProduct", "uid": uid, "sku": sku, "name": name, "image": image.flatMap { (value: Image) -> ResultMap in value.resultMap }, "price_range": priceRange.resultMap])
          }
          ...
          public var priceRange: PriceRange {
            get {
              return PriceRange(unsafeResultMap: resultMap["price_range"]! as! ResultMap)
            }
            set {
              resultMap.updateValue(newValue.resultMap, forKey: "price_range")
            }
          }
          ...
          public struct Image: GraphQLSelectionSet {
            ...
            public init(url: String? = nil, label: String? = nil, position: Int? = nil) {
              self.init(unsafeResultMap: ["__typename": "ProductImage", "url": url, "label": label, "position": position])
            }
          ...
          public struct PriceRange: GraphQLSelectionSet {
            public static let possibleTypes: [String] = ["PriceRange"]

            public static var selections: [GraphQLSelection] {
              return [
                GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
                GraphQLField("minimum_price", type: .nonNull(.object(MinimumPrice.selections))),
                GraphQLField("maximum_price", type: .object(MaximumPrice.selections)),
              ]
            }
            ...
            public init(minimumPrice: MinimumPrice, maximumPrice: MaximumPrice? = nil) {
              self.init(unsafeResultMap: ["__typename": "PriceRange", "minimum_price": minimumPrice.resultMap, "maximum_price": maximumPrice.flatMap { (value: MaximumPrice) -> ResultMap in value.resultMap }])
            }
            ...
            public var minimumPrice: MinimumPrice {
              get {
                return MinimumPrice(unsafeResultMap: resultMap["minimum_price"]! as! ResultMap)
              }
              set {
                resultMap.updateValue(newValue.resultMap, forKey: "minimum_price")
              }
            }

            /// The highest possible price for the product.
            public var maximumPrice: MaximumPrice? {
              get {
                return (resultMap["maximum_price"] as? ResultMap).flatMap { MaximumPrice(unsafeResultMap: $0) }
              }
              set {
                resultMap.updateValue(newValue?.resultMap, forKey: "maximum_price")
              }
            }

            public struct MinimumPrice: GraphQLSelectionSet {
              public static let possibleTypes: [String] = ["ProductPrice"]

              public static var selections: [GraphQLSelection] {
                return [
                  GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
                  GraphQLField("regular_price", type: .nonNull(.object(RegularPrice.selections))),
                  GraphQLField("final_price", type: .nonNull(.object(FinalPrice.selections))),
                ]
              }
              ...
              public init(regularPrice: RegularPrice, finalPrice: FinalPrice) {
                self.init(unsafeResultMap: ["__typename": "ProductPrice", "regular_price": regularPrice.resultMap, "final_price": finalPrice.resultMap])
              }
              ...
              public var regularPrice: RegularPrice {
                get {
                  return RegularPrice(unsafeResultMap: resultMap["regular_price"]! as! ResultMap)
                }
                set {
                  resultMap.updateValue(newValue.resultMap, forKey: "regular_price")
                }
              }
              ...
              public var finalPrice: FinalPrice {
                get {
                  return FinalPrice(unsafeResultMap: resultMap["final_price"]! as! ResultMap)
                }
                set {
                  resultMap.updateValue(newValue.resultMap, forKey: "final_price")
                }
              }

              public struct RegularPrice: GraphQLSelectionSet {
                ...
                public static var selections: [GraphQLSelection] {
                  return [
                    ...
                    GraphQLField("currency", type: .scalar(CurrencyEnum.self)),
                  ]
                }
                ...
                public init(value: Double? = nil, currency: CurrencyEnum? = nil) {
                  self.init(unsafeResultMap: ["__typename": "Money", "value": value, "currency": currency])
                }
                ...
                public var currency: CurrencyEnum? {
                  get {
                    return resultMap["currency"] as? CurrencyEnum
                  }
                  set {
              ...
              public struct FinalPrice: GraphQLSelectionSet {
                public static let possibleTypes: [String] = ["Money"]
            ...
            public struct MaximumPrice: GraphQLSelectionSet {
              public static let possibleTypes: [String] = ["ProductPrice"]
